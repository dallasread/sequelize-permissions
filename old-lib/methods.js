...
module.exports = {
    ...
    minimumPermit: function minimumPermit(instance, a, b, done) {
        var _ = this,
            model         = typeof a === 'object' ? a : b,
            actionOrLevel = typeof a !== 'object' ? a : b;

        return _.permit(instance, model, actionOrLevel, done, true);
    },

    permit: function permit(instance, a, b, done, isMin) {
        var _ = this,
            model         = typeof a === 'object' ? a : b,
            actionOrLevel = typeof a !== 'object' ? a : b;
        ...
        return new _.Sequelize.Promise(function (resolve, reject) {
            _.findPerm(instance, model, function(err, perm) {
                ...
                if (err) {
                    ...
                    if (isMin && perm.permissionLevel >= permissionLevel) {
                        return resolve(perm);
                    }
    ...
    setUserMethods: function setUserMethods() {
        ...
        proto.minimumPermit       = function minimumPermit()      { return monkeyWrap(this, _, _.minimumPermit, arguments);      };
    },
