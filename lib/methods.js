...
module.exports = {
        ...
        return new Promise(function (resolve) {
            ...
            via.findAll({
                ...
                for (var i = 0; i < perm.length; i++) {
                    instances.push(perm[i][Model.options.name.singular]);
                }
    ...
    safeUnPermit: function safeUnPermit(performer, user, instance, done) {
        var _ = this,
        ...
        return new Promise(function (resolve, reject) {
            ...
            via.findOne({
                ...
                if (!performerPerm) {
                    ...
                    userWhere[userName + 'Id']     = performerPerm.userId;
    ...
    safePermit: function safePermit(performer, user, instance, viaAttrs, done) {
        var _ = this,
            via = _.findViaTable(user.model, instance.model),
            userName = user.model.options.name.singular,
            instanceName = instance.model.options.name.singular,
    ...
    setUserMethods: function setUserMethods() {
        ...
        proto.safePermit    = function safePermit()    { return monkeyWrap(this, _, _.safePermit, arguments);      };
        proto.safeUnPermit  = function safeUnPermit()  { return monkeyWrap(this, _, _.safeUnPermit, arguments);      };
    },
