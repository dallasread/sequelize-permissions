...
module.exports = {
            ...
            return new _.Sequelize.Promise(function (resolve, reject) {
                if (instance[_.inheritPermsField]) {
                    _.findInheriter(instance).then(function(inheriter) {
                        ...
                        _.createImmediatePermsFor(instance, inheriter, isCreated).finally(resolve);
                    }).catch(resolve);
                } else {
                    resolve();
                }
    ...
    createImmediatePermsFor: function createImmediatePermsFor(instance, inheriter, isCreated) {
        var _ = this;
