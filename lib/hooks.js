...
module.exports = {
    ...
    setModelHooks: function setModelHooks() {
        ...
        for (var i = Models.length - 1; i >= 0; i--) {
            if (Models[i].permissionsHooked) continue;

            Models[i].permissionsHooked = true;
    ...
    setUserHooks: function setUserHooks() {
        ...
        _.User.afterDestroy('afterDestroyUserPerms', function() {
    ...
    setViaHooks: function setUserHooks() {
        ...
        for (var i = Models.length - 1; i >= 0; i--) {
            ...
            if (via.permissionsHooked) continue;

            via.permissionsHooked = true;
