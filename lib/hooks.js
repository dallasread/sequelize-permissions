...
module.exports = {
    ...
    createHeirPerms: function createHeirPerms(perm, modelIds, options, Models, isCreated) {
        ...
        return new _.Sequelize.Promise(function (resolve, reject) {
            ...
            if (modelIds.indexOf(perm[_.modelIdString]) === -1) modelIds.push(perm[_.modelIdString]);
            ...
            _.getDescendantIds(Model, modelIds, ParentModel).then(function(ids) {
                ...
                if (isCreated) {
                    ...
                    for (var i = ids.length - 1; i >= 0; i--) {
                        ...
                        insert[permitter.userIdString] = perm[_.userIdString];
                    ...
                    where[permitter.userIdString] = perm[_.userIdString];
                ...
                query.then(function(arr) {
                    _.createHeirPerms(perm, ids, options, Models, isCreated).finally(resolve);
                }).catch(resolve)
            }).catch(resolve);
        });
    },
        ...
        return new _.Sequelize.Promise(function (resolve, reject) {
            ...
            Model.findAll({ where: where }).then(function(instances) {
                ...
                for (var i = instances.length - 1; i >= 0; i--) {
                    ...
                    if (ids.indexOf(instance.id) === -1) newIds.push(instance.id);
                }
    ...
    destroyHeirPerms: function destroyHeirPerms(perm, modelIds, options, Models) {
        ...
        return new _.Sequelize.Promise(function (resolve, reject) {
            ...
            _.getDescendantIds(Model, modelIds, ParentModel, true).then(function(ids) {
            ...
            permitter.Via.findAll({
                ...
                if (isCreated) {
                    ...
                    for (var i = perms.length - 1; i >= 0; i--) {
                        ...
                        insert[_.userIdString] = perm[_.userIdString];
                    ...
                    where[permitter.userIdString] = perm[_.userIdString];
                    where[permitter.modelIdString] = perms.map(function(p) {
                        return p[permitter.modelIdString];
                    });
