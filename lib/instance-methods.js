...
module.exports = {
    ...
    findPermitted: function findPermitted(instance, a, b) {
        ...
        return new _.Sequelize.Promise(function (resolve, reject) {
            Model.findAll(query).then(function(instances) {
                ...
                instance.findPermitted(permitter.groupedAs).then(function(groups) {
                    ...
                    Model.findAll({
                        include: [{
                            ...
                            where: {
                                teamId: groupIds,
                                permissionLevel: {
                                    gte: _.integerForLevel(originalQuery)
                                }
                            }
                        }]
    ...
    integerForLevel: function integerForLevel(level) {
        ...
        if (typeof level === 'object' && typeof level.gte !== 'undefined') level = level.gte;
